...
int BST_312 <ItemType>::countNodes(TreeNode* t) const
{
    ...
    if(t == NULL)
        ...
        count = countNodes(t->left) + countNodes(t->right) + 1;
...
{
    //YOUR CODE GOES HERE
    vector<ItemType> theTraversal;
    preOrderTraversal(root, theTraversal);
    return theTraversal;
}
...
vector<ItemType> BST_312 <ItemType>::inOrderTraversal()
{
    //YOUR CODE GOES HERE
    vector<ItemType> theTraversal;
    inOrderTraversal(root, theTraversal);
    return theTraversal;
}
...
vector<ItemType> BST_312 <ItemType>::postOrderTraversal()
{
    //YOUR CODE GOES HERE
    vector<ItemType> theTraversal;
    postOrderTraversal(root, theTraversal);
    return theTraversal;
}
